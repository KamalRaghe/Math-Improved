...
export default function Foil3({num1,num2,close}){  
    ...
    return (
        <div className="Help">
            {extra && !step1 && sign === 'x' && Q1 < 10 && Q2 < 10 && <HelpTimes close={Extra} num1 ={-1*Q1} num2 = {-1*Q2}/>}
            {extra && sign === 'x' && (Q1 >= 10 || Q2 >= 10) && <StepTimes close={Extra} num1 ={-1*Q1} num2 = {-1*Q2}/>}
            {extra && sign === '+' && Q1 < 10 && Q2 < 10 && <HelpAdd close={Extra} num1 ={-1*Q1} num2 = {-1*Q2}/>}
