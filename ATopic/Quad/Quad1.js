...
export default function Quad1({num1,num2,close}){  
    ...
    const [answer, setAnswers] = useState(num2-num1)
    const[Q1, setQ1] = useState(num2-num1) 
    const[Q2, setQ2] = useState(num2-num1)
    const [sign, setSign] = useState('x')
    const[Q3, setQ3] = useState((num1-num2)) 
    const[Q4, setQ4] = useState(Math.sqrt(((num1-num2)*(num1-num2))+(4*num1*num2)))
    ...
    function Count(){
        ...
        if(step1 === true){
            ...
            setC(true)
            setA(false)
            setAnswers(-1*num1*num2)
            
        }if(step4 === true){
            setStep5(true)
            setStep4(false)
            setC4(<div>({-1*num1*num2})</div>)
            ...
            setStep5(false)
            setStep6(true)
            setAnswers((num2-num1)*(num2-num1))
        }if(step6 === true){
            setStep6(false)
            setStep7(true)
            setQ1(-4)
            ...
            setStep10(true)
            setSign('+')
            setQ1((num2-num1)*(num2-num1))
            setQ2(4*num1*num2)
            setAnswers(((num2-num1)*(num2-num1))+(4*num1*num2))
            setC5()
        }if(step10 === true){
            setStep10(false)
            setStep11(true)
            ...
            setStep(true)
            setQ1(num1-num2)
            setQ2(Math.sqrt(((num1-num2)*(num1-num2))+(4*num1*num2)))
            setSign('+')
            setAnswers((num1-num2+(Math.sqrt(((num1-num2)*(num1-num2))+(4*num1*num2)))))
        }if(step12 === true){
            setStep12(false)
            setStep13(true)
            setQ1(answer)
            ...
            setStep13(false)
            setStep14(true)
            setQ1(Math.sqrt(((num1-num2)*(num1-num2))+(4*num1*num2)))
            setQ2(c1)
            setSign('-')
            setSign2('-')
            setQ3(c1)
            setQ4(Math.sqrt(((num1-num2)*(num1-num2))+(4*num1*num2)))
            setAnswers(c1-Math.sqrt(((num1-num2)*(num1-num2))+(4*num1*num2)))
        }if(step14 === true){
            setStep14(false)
            setStep15(true)
            setQ1(-1*answer)
    ...
    return (
        <div className="Help">
            ...
            {extra && !step1 && sign === 'x' && Q1 < 10 && Q2 < 10 && -Q2 < 10 && <HelpTimes close={Extra} num1 ={Q1 > -1 ? Q1:-1*Q1} num2 = {Q2 > -1 ? Q2:-1*Q2}/>}
            {extra && sign === 'x' && (Q1 >= 10 || Q2 >= 10 || -Q2 >= 10) && <StepTimes close={Extra} num1 ={Q1 > -1 ? Q1:-1*Q1} num2 = {Q2 > -1 ? Q2:-1*Q2}/>}
            ...
            { done && <div className="double center" >𝑥<span style={{fontSize:'20px',position:'relative',padding:"2px", top:"-13px",paddingLeft:"2px",paddingRight:"5px"}}>2</span>
                ...
                {!almost && !nearly && <div className="center relative MoveUp" style={{top:"-20px",fontSize:"30px"}}>
                    ...
                    {(!(c2 === (num1-num2)*(num1-num2))|| step10) ?<div className="Green">{c2}</div>: c2}{!(c2 === (num1-num2)*(num1-num2))  && <span className="Green" style={{fontSize:'20px',position:'relative',padding:"2px", top:"-13px",paddingLeft:"2px",paddingRight:"5px"}}>2</span>} {(step9 || step10) ? <div style={{padding:'5px'}} >+</div> : '-'} {(((c2 === (num1-num2)*(num1-num2)) && times === 1) || step10 )? <div className="Green" style={{padding:'2px'}} >{4*times}</div>:4*times}{Q2 === 1 ? <div className="Green" >{c3}</div> : c3}{Q2 === -num1*num2 ? <div className="Green" >{c4}</div> :c4}</div>
                </div>}
                ...
                {nearly && !split && <div className="center relative double" style={{top:"-20px"}}>
                    ...
                    <div className="double Green center root-top"><span className="root-tip" style={{left:'-16px'}}></span><span className="root-right" style={{left:'-6px'}} ></span><span className="root-left" style={{left:'-14px'}}></span>
                        {((num2-num1)*(num2-num1))+(4*num1*num2)}
                    </div>
                </div>}
                ...
                {split && !done && <div className="center relative double" style={{top:"-20px",left:"30px"}}>
                   {!positive ? <button className="Green carry center" onClick={()=>{setPositive(true);setC1(num1-num2)}} >-{c1}</button> :c1}<div style={{paddingRight:"10px",paddingLeft:"10px"}} >{ step11 && positive ? <button className="carry Green" onClick={()=>{setStep11(false);setStep12(true)}} >±</button> :<div>±</div>}</div>
                ...
                {step13 && <div className="center relative Green double" style={{top:"-50px",left:"-10px"}}>
                   {c1+Math.sqrt(((num1-num2)*(num1-num2))+(4*num1*num2))}
                </div>}
                ...
                {done && <div className="Green center double" >𝑥 = {num1} or 𝑥 = {-1*num2}</div>}
