...
export default function Quad2({num1,num2,close}){  
    ...
    const[Q2, setQ2] = useState(num1-num2)
    const [sign, setSign] = useState('x')
    const[Q3, setQ3] = useState((num2-num1)) 
    ...
    function Count(){
        ...
        if(step1 === true){
            ...
            setSign('-')
            setAnswers((num2-num1+(Math.sqrt(((num1-num2)*(num1-num2))+(4*num1*num2)))))
        }if(step12 === true){
            setStep12(false)
            setStep13(true)
            setQ1((num2-num1+(Math.sqrt(((num1-num2)*(num1-num2))+(4*num1*num2)))))
            setQ2(2)
            setSign('÷')
            setSign2('÷')
            setQ3((num2-num1+(Math.sqrt(((num1-num2)*(num1-num2))+(4*num1*num2)))))
            setQ4(2)
            setAnswers(answer/2)
        }if(step13 === true){
            setStep13(false)
    ...
    return (
        <div className="Help">
            ...
            {extra && sign === 'x' && (Q1 >= 10 || Q2 >= 10 || -1*Q2 >= 10) && <StepTimes close={Extra} num1 ={Q1 > -1 ? Q1:-1*Q1} num2 = {Q2 > -1 ? Q2:-1*Q2}/>}
