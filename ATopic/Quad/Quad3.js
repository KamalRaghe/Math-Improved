...
export default function Quad3({num1,num2,close}){  
    ...
    return (
        <div className="Help">
            ...
            {extra && !step1 && sign === 'x' && Q1 < 10 && Q2 < 10 && <HelpTimes close={Extra} num1 ={Q1 >= 0 ? Q1:-Q1} num2 = {Q2 >= 0 ? Q2:-Q2}/>}
            {extra && sign === 'x' && (Q1 >= 10 || Q2 >= 10) && <StepTimes close={Extra} num1 ={Q1 >= 0 ? Q1:-Q1} num2 = {Q2 >= 0 ? Q2:-Q2}/>}
            ...
            { done && <div className="double center" >𝑥<span style={{fontSize:'20px',position:'relative',padding:"2px", top:"-13px",paddingLeft:"2px",paddingRight:"5px"}}>2</span>
                ...
                {step13 && <div className="center relative Green double" style={{top:"-50px",left:"-11px"}}>
                ...
                {step15 && <div className="center relative double Green" style={{top:"-50px",left:"-10px"}}>
                   {c1-Math.sqrt(((num1+num2)*(num2+num1))-(4*num1*num2))}
                </div>}
                ...
                {done && <div className="Green center double" >𝑥 = {num1} or 𝑥 = {num2}</div>}
