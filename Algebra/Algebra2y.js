...
export default function Algebra2y({num1,num2,num5,close}){  
    ...
    return (
        <div className="Help">
            ...
            {step1 && <div className="double center" >{num5}y+ <button onClick={() => {setStep1(false);setStep2(true)}} className="carry Green" >{num1} </button> = {(num2*num5)+num1}</div>}
            
            {step2 && <div className="double center" >{num5}y<span className="hide" >.</span><span className="across2" > = {(num2*num5)+num1}</span> <span className="hide" >.</span> <span className="across" ><button  onClick={() => {setStep2(false);setStep3(true);setDone(false)}} className="carry Red" > + </button></span> <span className="hide" >.</span> <span className="across" >{num1}</span> </div>}

            {step3 && <div className="double center" >{num5}y= {(num2*num5)+num1} <span className="hide" >.</span> - <span className="hide" >.</span> {num1} </div>}
            ...
            {step5 && <div className="double center"><span className="center column">
                ...
                </span>{num5}</span>y= <span className="hide">.</span> <span className="center column">
                <span style={{borderBottom:'2px solid black'}} >
                <span className="hide">.</span>
               ...
               {!done &&<div className='center wrap absolute StepAnswer'>
                   ...
                   <Step big = {true} value = {step7 ? `x=${answer+arr[1]}` : answer+arr[1]}  answer={ step7 ? `x=${answer}` :answer} Count ={Count} done = {done} mistake={Nothing}/>
