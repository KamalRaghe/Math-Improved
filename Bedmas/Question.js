...
export default function Question({num1,num2,num4,num5,close}){  
    ...
    return (
        <div className="Help">
            ...
            <div className="double center">{num4} x {num5} + ({num1} + {num2})<span style={{fontSize:'20px',position:'relative', top:"-19px"}}>2</span> = </div>
            {!step1 &&  <div className="double center">{num4} x {num5} + ({num1 + num2})<span style={{fontSize:'20px',position:'relative', top:"-19px"}}>2</span> = </div>}
            {!step1 && !step2 &&  <div className="double center">{num4} x {num5} + {(num1 + num2)*(num1+num2)} =</div>}
            {!step1 && !step2 && !step3 &&  <div className="double center">{num4*num5} + {(num1 + num2)*(num1+num2)} =</div>}
