...
export default function Question1({num1,num2,num4,num5,close}){  
    ...
    function Count(){
        ...
        if(step1 === true){
           ...
           setAnswers((num1+num2)*(num1+num2)) 
            ...
            setSign('+')
            setAnswers((num4*num5)+((num1+num2)*(num1+num2))) 
        }if(step4 === true){
            setStep4(false)
            setStep5(true) 
        }if (step5 === true){
    ...
    return (
        <div className="Help">
            ...
            <div className="double center">({num1} + {num2})<span style={{fontSize:'20px',position:'relative', top:"-19px"}}>2</span> + {num4} x {num5} = </div>
            {!step1 &&  <div className="double center">({num1 + num2})<span style={{fontSize:'20px',position:'relative', top:"-19px"}}>2</span> + {num4} x {num5} = </div>}
            {!step1 && !step2 &&  <div className="double center">{(num1 + num2)*(num1+num2)} + {num4} x {num5} =</div>}
            {!step1 && !step2 && !step3 &&  <div className="double center">{(num1 + num2)*(num1+num2)} + {num4*num5} =</div>}
            {!step1 && !step2 && !step3 && !step4 && <div className="double center Green">{(num4*num5) + (num1 + num2)*(num1+num2)}</div>}
