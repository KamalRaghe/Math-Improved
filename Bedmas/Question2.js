...
export default function Question2({num1,num2,num4,num5,close}){ 
    ...
    return (
        <div className="Help">
            ...
            <div className="double center">({num1} + {num2}) + {num5*num4} ÷ {num4} = </div>
            {!step1 && <div className="double center">{num1+num2} + {num5*num4} ÷ {num4} = </div>}
            {!step1 && !step2 &&  <div className="double center">{num1+num2} + {num5} = </div>}
            {!step1 && !step2 && !step3 && <div className="Green double center">{num1+num2 + num5}</div>}
            {!(!step1 && !step2 && !step3) && <div className=" double center Green absolute StepQuestion">{Q1} {sign} {Q2} = </div>}  
