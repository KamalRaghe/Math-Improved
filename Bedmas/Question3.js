...
export default function Question3({num1,num2,num4,num5,num6,close}){  
    ...
    function Count(){
        ...
        if(step1 === true){
            ...
            setQ2(num2+num1)
            setSign('x')
            setAnswers((num1+num2)*(num1+num2))
        }if(step2 === true){
            setStep2(false)
            setStep3(true)
            setQ1(num4)
            setQ2(num5)
            setSign("x")
            setAnswers(num5*num4)
        }if(step3=== true){
            setStep3(false)
            setStep4(true)
            setQ1((num1+num2)*(num1+num2))
            setQ2(num6)
            setSign("+")
            setAnswers((num1+num2)*(num1+num2)+num6)
        }if(step4 === true){
            setStep4(false)
            setStep5(true)
            setQ1((num1+num2)*(num1+num2)+num6)
            setQ2(num4*num5)
            setSign("-")
            setAnswers((num1+num2)*(num1+num2)+num6-(num4*num5))
        }if(step5 === true){
            setStep5(false)
            setStep6(true)
        }if(step6 === true){
    ...
    return (
        <div className="Help">
            ...
            {extra && sign === '-' && Q1 < 10 && Q2 < 10 && Q2 <= Q1 && <HelpMinus close={Extra} num1 ={Q1} num2 = {Q2}/>}
            {extra && sign === '-' && (Q1 >= 10 || Q2 >= 10) && Q2 <= Q1  &&<StepMinus close={Extra} num1 ={Q1} num2 = {Q2}/>}
            {extra && sign === '-' && Q1 < 10 && Q2 < 10 && Q2 > Q1 && <HelpMinus close={Extra} num1 ={Q2} num2 = {Q1}/>}
            {extra && sign === '-' && (Q1 >= 10 || Q2 >= 10) && Q2 > Q1 && <StepMinus close={Extra} num1 ={Q2} num2 = {Q1}/>}
            <div className='cancel'><button className='cancel-btn' onClick = {close}>X</button></div>
            <div className="double center">({num1} + {num2})<span style={{fontSize:'20px',position:'relative', top:"-19px"}}>2</span> + {num6}  - {num4} x {num5} =</div>
            {!step1 && <div className="double center">({num1+num2})<span style={{fontSize:'20px',position:'relative', top:"-19px"}}>2</span> + {num6}  - {num4} x {num5} =</div>}
            {!step1 && !step2 &&  <div className="double center">({(num1+num2)*(num1+num2)}) + {num6}  - {num4} x {num5} =</div>}
            {!step1 && !step2 && !step3 && <div className="double center">({(num1+num2)*(num1+num2)}) + {num6}  - {num4*num5} =</div>}
            {!step1 && !step2 && !step3 && !step4 && <div className="double center">{(num1+num2)*(num1+num2)+num6}  - {num4*num5} =</div>}
            {!step1 && !step2 && !step3 && !step4 && !step5 && <div className="Green double center">{(num1+num2)*(num1+num2)+num6 - (num4*num5)}</div>}
