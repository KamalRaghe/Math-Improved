...
export default function Question4({num1,num2,num4,num5,num6,close}){  
    ...
    function Count(){
        ...
        if(step1 === true){
            ...
            setQ2(num5)
            setSign("+")
            setAnswers((num1+num2)+(num4*num6)+num5)
        }if(step4 === true){
            setStep4(false)
            setStep5(true)
        }if(step5 === true){
    ...
    return (
        <div className="Help">
            ...
            <div className="double center">({num1} + {num2}) + {num6} x {num4} + {num5} =</div>
            {!step1 && <div className="double center">{num1+num2} + {num6} x {num4} + {num5} =</div>}
            {!step1 && !step2 &&  <div className="double center">{num1+num2} + {num6*num4} + {num5} =</div>}
            {!step1 && !step2 && !step3 && <div className="double center">{num1+num2+num6*num4} + {num5} =</div>}
            {!step1 && !step2 && !step3 && !step4 && <div className="double center Green">{num1+num2+(num6*num4)+num5}</div>}
