...
export default function Question5({num1,num2,num4,num5,num6,close}){  
    ...
    function Count(){
        ...
        if(step1 === true){
            ...
            setQ1(num4*num5)
            setSign("+")
            setAnswers((num1+num2)+(num4*num5))
        }if(step3=== true){
            setStep3(false)
            setStep4(true)
            setQ1((num1+num2)+(num4*num5))
            setQ2(num6)
            setSign("+")
            setAnswers((num1+num2)+(num4*num5)+num6)
        }if(step4 === true){
            setStep4(false)
            setStep5(true)
        }if(step5 === true){
    ...
    return (
        <div className="Help">
            ...
            <div className="double center">{num4} x {num5} + ({num1} + {num2}) + {num6} = </div>
            {!step1 && <div className="double center"> {num4} x {num5} + {num1+num2} + {num6} =</div>}
            {!step1 && !step2 &&  <div className="double center">{num4*num5} + {num1+num2} + {num6} =</div>}
            {!step1 && !step2 && !step3 && <div className="double center">{(num4*num5)+num1+num2} + {num6} =</div>}
            {!step1 && !step2 && !step3 && !step4 && <div className="double center Green">{(num4*num5)+num1+num2+num6}</div>}
