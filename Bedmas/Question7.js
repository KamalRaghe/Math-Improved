...
export default function Question7({num1,num2,num4,num5,num6,close}){  
    ...
    function Count(){
        ...
        if(step1 === true){
            ...
            setQ2(num4)
            setSign('x')
            setAnswers(num4*(num1+num2))
        }if(step2 === true){
            setStep2(false)
            setStep3(true)
            setQ1(num6)
            setQ2((num4)*(num1+num2))
            setSign("+")
            setAnswers(((num4)*(num1+num2))+num6)
        }if(step3=== true){
            setStep3(false)
            setStep4(true)
            setQ1(((num4)*(num1+num2))+num6)
            setQ2(num5)
            setSign("+")
            setAnswers((((num4)*(num1+num2))+num6)+num5)
        }if(step4 === true){
            setStep4(false)
            setStep5(true)
        }if(step5 === true){
    ...
    return (
        <div className="Help">
            ...
            <div className="double center">{num6} + ({num1} + {num2}) x {num4} + {num5} =</div>
            {!step1 && <div className="double center">{num6} + {num1+num2} x {num4} + {num5} =</div>}
            {!step1 && !step2 &&  <div className="double center">{num6} + {(num1+num2)*num4} + {num5} =</div>}
