...
export default function Question8({num1,num2,num4,num5,num6,close}){  
    ...
    function Count(){
        ...
        if(step1 === true){
            ...
            setQ2(num5)
            setSign("+")
            setAnswers((num4*num4)+num5)
        }if(step4 === true){
            setStep4(false)
            setStep5(true)
            setQ1((num4*num4)+num5)
            setQ2(((num6)*(num1+num2)))
            setSign("+")
            setAnswers(((num4*num4)+num5)+((num6)*(num1+num2)))
        }if(step5 === true){
            setStep5(false)
            setStep6(true)
        }if(step6 === true){
    ...
    return (
        <div className="Help">
            ...
            <div className="double center">{num4}<span style={{fontSize:'20px',position:'relative', top:"-19px"}}>2</span> + {num5} + ({num1} + {num2}) x {num6} = </div>
            {!step1 && <div className="double center">{num4}<span style={{fontSize:'20px',position:'relative', top:"-19px"}}>2</span> + {num5} + {num1+num2} x {num6} = </div>}
            {!step1 && !step2 &&  <div className="double center">{num4*num4} + {num5} + {num1+num2} x {num6} = </div>}
            {!step1 && !step2 && !step3 && <div className="double center">{num4*num4} + {num5} + {(num1+num2)*num6} = </div>}
            {!step1 && !step2 && !step3 && !step4 && <div className="double center ">{(num4*num4)+num5} + {(num1+num2)*num6} =</div>}
            {!step1 && !step2 && !step3 && !step4 && !step5 && <div className="double center Green">{((num4*num4)+num5)+((num1+num2)*num6)}</div>}
