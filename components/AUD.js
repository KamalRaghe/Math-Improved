...
export default function AUD({num1,num2,close,num4,num5}){  
    ...
    return (
        <div className="Help">
            ...
            {((step2 &&  num1*count/num2+num4*count/num5 < count) || step5 ) && extra && <Question1  whole={num1*count/num2+num4*count/num5 > count && 1} num1={num1*count/num2+num4*count/num5 > num4 ? num1*count/num2+num4*count/num5-count : num1*count/num2+num4*count/num5} num2={count} close={Extra} />}
            ...
            {!done && !step2 && !step4 && <div className='center wrap absolute StepAnswer'>
               ...
               {done && add && <div className='center wrap absolute StepAnswer' style={{width:'100%',top:"350px"}} >
                   <StepF whole={num1*count/num2+num4*count/num5 >= count && 1} value1 = {((num1*count/num2+num4*count/num5)%count)+arr[0]}  answer1={(num1*count/num2+num4*count/num5)%count} value2 = {count}  answer2={count}  Count ={Count} mistake={Nothing}/>
                   <StepF whole={num1*count/num2+num4*count/num5 >= count && 1} value1 = {((num1*count/num2+num4*count/num5)%count)+arr[2]}  answer1={(num1*count/num2+num4*count/num5)%count} value2 = {count}  answer2={count}  Count ={Count} mistake={Nothing}/>
                   <StepF whole={num1*count/num2+num4*count/num5 >= count && 1} value1 = {((num1*count/num2+num4*count/num5)%count)+arr[3]}  answer1={(num1*count/num2+num4*count/num5)%count} value2 = {count}  answer2={count}  Count ={Count} mistake={Nothing}/>
                   <StepF whole={num1*count/num2+num4*count/num5 >= count && 1} value1 = {((num1*count/num2+num4*count/num5)%count)+arr[1]}  answer1={(num1*count/num2+num4*count/num5)%count} value2 = {count}  answer2={count}  Count ={Count} mistake={Nothing}/>
