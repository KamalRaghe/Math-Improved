...
export default function AUD({num1,num2,close,num4,num5}){  
    ...
    return (
        <div className="Help">
            ...
            {((step2 &&  num1*count/num2+num4*count/num5 < count) || step5 ) && extra && <Question1  whole={num1*count/num2+num4*count/num5 > count && 1} num1={(num1*count/num2+num4*count/num5)%count} num2={count} close={Extra} />}
