        ...
        <div>
            <button className='choice-stretch center' style={{padding:'30px 10px'}} onClick={()=>{Do()}}>
                ...
                <div className="column center" >
                    { !(value1 === 0) && !(beginning === true) && <div className="center" style={{borderBottom:'2px solid black', width:'30px'}} >
                        { show1 > 0 && show1}
                        {show1 <= 0 && show1+answer1+3}
                    </div>}
                    { !(value1 === 0) && !(beginning === true) && <div >{show2 <= 1 && answer2+num1}{show2 > 1 && show2}</div>}
                    {answer1 > 0 && beginning === true &&<div className="center" style={{borderBottom:'2px solid black', width:'30px'}} >
                        {show1 > 0 && show1}
