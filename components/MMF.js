...
export default function MMF({num1,num2,close,num4,num5,whole1,whole2}){  
    ...
    function Count(){
        ...
        if(before1 === true){
            ...
            setBefore4(false)
            setStep1(true)
            setQ1(num1+(whole1*num2))
            setQ2(num4+(whole2*num5))
            setSign('x')
            setAnswers((num1+(whole1*num2))*(num4+(whole2*num5)))
        }
        if(step1 === true){
            setStep1(false)
            setStep2(true)
    ...
    return (
        <div className="Help">
            ...
            {done && extra && <Improper whole={Math.floor(((num1+(whole1*num2))*(num4+(whole2*num5)))/(num5*num2))} num1={((num1+(whole1*num2))*(num4+(whole2*num5))%(num2*num5))} num2={num2*num5} close={Extra}/>}
            ...
            <div className=" double center">
                    ...
                    <div className="column center" >
                        <div className="center" style={{borderBottom:'2px solid black',padding:"0px 10px"}} >
                            ...
                            {!(before1 || before2 || before3 || before4) && num4+(whole2*num5)}
                        </div>
                        <div className="center" >
                            {num5}
                        </div>
                    ...
                    {(step2 || step3) && <div className="column center Green" >
                        <div className="center" style={{borderBottom:'2px solid green',padding:"0px 10px"}} >
                            {(num1+(whole1*num2))*(num4+(whole2*num5))}
                        </div>
                        <div className="center" >
