        ...
        return(
           <div className="Help" style={{zIndex:'20', border:'10px solid orange'}}>
               ...
               {dextraadd && <div className='center wrap absolute StepAnswer' style={{width:'100%',top:"340px"}} >
                   <StepF whole={Math.floor((num5-num2)/(num4-num1))} value1 = {(num5-num2)+arr[0]}  answer1={(num5-num2)} value2 = {(num5*num2)}  answer2={num5*num2}  Count ={Count} mistake={Nothing}/>
                   <StepF whole={Math.floor((num5-num2)/(num4-num1))} value1 = {(num5-num2)+arr[2]}  answer1={(num5-num2)} value2 = {(num5*num2)}  answer2={num5*num2}  Count ={Count} mistake={Nothing}/>
                   <StepF whole={Math.floor((num5-num2)/(num4-num1))} value1 = {(num5-num2)+arr[3]}  answer1={(num5-num2)} value2 = {(num5*num2)}  answer2={num5*num2}  Count ={Count} mistake={Nothing}/>
                   <StepF whole={Math.floor((num5-num2)/(num4-num1))} value1 = {(num5-num2)+arr[1]}  answer1={(num5-num2)} value2 = {(num5*num2)}  answer2={num5*num2}  Count ={Count} mistake={Nothing}/>
