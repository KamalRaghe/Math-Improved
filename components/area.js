...
export default function Area({num1,num2,close}){
    ...
    return (
        <div className="Help center column" style={{zIndex:'50'}}>
            ...
            <div className='cancel' style={{width:"100%"}}><button className='cancel-btn' onClick = {close}>X</button></div>
               ...
               <div className="double relative" style={{top:"75px",left:"25px",color:'white'}} >A =</div>
               ...
               <div className="double relative" style={{padding:'30px',top:'-30px'}} >A = S<span style={{fontSize:'20px',position:'relative', top:"-13px"}}>2</span></div>
