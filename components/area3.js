...
export default function Area3({num1,num2,close}){
    ...
    return (
        <div className="Help center column" style={{zIndex:'50'}}>
            ...
            {extra && sign === '÷' && <HelpDiv close={Extra} num1 ={Q1} num2 = {Q2}/>}
             <div className="double relative" style={{top:'10px',zIndex:'20'}} >A =</div>
             <div className="relative" style={{width:"180px",top:"100px",left:"-5px",fontSize:'20px',color:'white',borderTop:'2px dotted lightgrey',padding:"5px",rotate:"90deg"}} ></div>
                <div><div className="double" style={{borderBottom:"100px solid black",borderRight:'50px solid transparent',borderLeft:'50px solid transparent'}}></div>
                    <div className="relative center" style={{top:'5px',fontSize:'20px'}} >{num2*2}</div>
                    <div className="relative center" style={{top:'-80px',left:"15px",fontSize:'20px',color:'white'}} >{num1}</div>
                </div>
               <div className="double center relative" style={{padding:'60px',top:"-30px"}} >A = <span className="column" ><span className="relative" style={{borderBottom:"2px solid black", width:'30px',top:"-20px",left:'10px'}}>1</span><span className="relative" style={{top:'25px',left:"-10px"}} >2</span></span>bh</div>
