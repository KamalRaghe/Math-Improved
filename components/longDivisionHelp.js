...
useEffect(()=>{
  ...
  return(
        <div className="Help">
            ...
            <div className='cancel'><button className='cancel-btn' style={{zIndex:"100"}} onClick={()=> close()} >X</button></div>
            {(!remainder || num2%num1 === 0)  && <span className="center absolute Green"  style={{fontSize: '30px',width:'88%',top:'65px'}}>{digit && <div className="Green" style={{position:"fixed",top:"85px",right:"193px"}} >0</div>}{<div className="Green" style={{position:"fixed",top:"85px",right:"163px"}} >{main}</div>}</span>}
            { remainder && num2%num1 != 0 && <span className="center absolute Green"  style={{fontSize:'30px',width:'88%',top:'65px'}}>{num1 > 9 && <span className="hide" >00.</span>}{<div className="Green" style={{position:"fixed",top:"85px",right:"163px"}} >{main}</div>} {<div className="Green" style={{position:"fixed",top:"85px",right:"123px"}} >R{num2%num1}</div>} </span>}
            <div className="center" style={{fontSize: '30px'}}>
                {num1}
                <div style={{borderLeft: '3px solid black', borderTop: '3px solid black', marginLeft:'5px', paddingRight:'10px'}}>
            ...
            <div className="center absolute" style={{fontSize: '30px',width:'88%'}}>
            ...
            {((number1 >= 10 && num1 < 10) || (number1 >= 100 && num1 >=10)) && Minus1 &&
            <div className="center absolute" style={{fontSize: '30px',width:'88%'}}>
                {num1 >= 10 && <span className="hide" >0</span>}<span style={{borderBottom:'2px solid black'}}>-{minus1}</span>
            </div>}

            {((number1 < 10 && num1 < 10) || (number1 < 100 && num1 >=10)) && right1 && 
            <div className="center absolute " style={{fontSize: '30px',width:'88%',top:'190px'}}>
                {num1 >= 10 &&<span className="hide" >00</span>}<span>{answer1}</span>
            </div>}

            {((number1 >= 10 && num1 < 10) || (number1 >= 100 && num1 >=10)) && right1 && 
            <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'190px'}}><span>
                {answer1}</span>
            </div>}

            {((number1 < 10 && num1 < 10) || (number1 < 100 && num1 >=10)) && number1 === minus1  && right2 && 
            <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'190px'}}>
                <span>{answer1}</span>
            </div>}

            {((number1 >= 10 && num1 < 10) || (number1 >= 100 && num1 >=10)) && number1 === minus1 && answer1 >= num1 && right2 && 
            <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'190px'}}>
                <span>0{answer1}</span>
            </div>}
            {!remainder && ((number1 >= 10 && num1 < 10) || (number1 >= 100 && num1 >=10)) && number1 === minus1 && answer1 < num1 && right2 && 
            <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'190px'}}>
                <button className="carry Green" onClick={()=>{setRemainder(true);setDone(true);setMain(main*10)}} 
                style={{fontSize:'30px'}}>0{answer1}</button>
            </div>}
            {remainder && ((number1 >= 10 && num1 < 10) || (number1 >= 100 && num1 >=10)) && number1 === minus1 && answer1 < num1 && right2 && 
            <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'190px'}}>
                <span>{answer1}</span>
            ...
            {((number1 < 10 && num1 < 10) || (number1 < 100 && num1 >=10)) && !(number1 === minus1) && right2 && 
            <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'190px'}}>
                {num1 >= 10 &&<span className="hide" >0//</span>}<span>{answer1}</span>
            </div>}
            ...
            {((number1 < 10 && num1 < 10) || (number1 < 100 && num1 >=10)) && Minus2 &&
            <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'220px'}}>
                {num1 >= 10 &&<span className="hide" >00</span>}
                <span style={{borderBottom:'2px solid black'}}>-{minus2}</span>
            </div>}
            ...
            {(((number1 < 10 && num1 < 10) || (number1 < 100 && num1 >=10))) && right3 && 
            <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'255px'}}>
                <span>{num1 > 9 && <span className="hide" >00.</span>}{answer2}</span>
            </div>}
            
            {!remainder && ((number1 >= 10 && num1 < 10) || (number1 >= 100 && num1 >=10))  && right3 && 
            <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'255px'}}>
                <button className="Green carry" style={{fontSize:'30px'}} onClick={() => {setRemainder(true);setDone(true)} }>
                    {answer2}
                </button>
            </div>}
            ...
            {remainder && ((number1 >= 10 && num1 < 10) || (number1 >= 100 && num1 >=10))  && right3 && 
            <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'255px'}}>
                <span style={{fontSize:'30px'}}>{answer2}</span>
            </div>}

            {((number1 < 10 && num1 < 10) || (number1 < 100 && num1 >=10)) && Minus3 &&
                <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'285px'}}>
                    {num1 > 9 && <span className="hide" >00.</span>}
                    <span style={{borderBottom:'2px solid black'}}>-{minus3}</span>
                </div>}
            {!remainder && ((number1 < 10 && num1 < 10) || (number1 < 100 && num1 >=10)) && step8 && 
                <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'320px'}}>
                    <button className="Green carry" style={{fontSize:'30px'}} 
                    onClick={() => {setRemainder(true);setDone(true)} }>
                        {num1 > 9 && <span className="hide" >0.</span>}{answer3}
                    </button>
                </div>}
            {remainder && ((number1 < 10 && num1 < 10) || (number1 < 100 && num1 >=10)) && step8 && 
                <div className="center absolute" style={{fontSize: '30px',width:'88%',top:'320px'}}>
                    <span style={{fontSize:'30px'}}>{num1 > 9 && <span className="hide" >0.</span>}
                    {answer3}</span>
                </div>}
            ...
            {big && <div className="double center absolute Pop Red " style={{top:"220px",left:'100px', fontSize:"60px"}}>Too big</div>}
            {small && <div className="double center absolute Pop Red " style={{top:"220px",left:'100px', fontSize:"60px"}}>Too Small</div>}
            ...
            {!done && minus && <div className="center wrap absolute StepQuestion double" style={{zIndex:"-10"}} >{number5} - {number6} = </div>}  
            {!done && minus &&<div className='center wrap absolute StepAnswer'>
