...
function LongDivisionHelp({close, num1 , num2}){
  ...
  function Count(){
    ...
    }else if(step5 === true && num1 > (answer1 - number4*num1) && number1 >= 10){
        ...
        <div className="Help">
            ...
            <div className="center" style={{fontSize: '30px'}}>
                {num1}<div style={{borderLeft: '3px solid black', borderTop: '3px solid black', marginLeft:'5px', paddingRight:'10px'}}>
                    ...
                    {!(answer1 < num1 && right2) && !step6 && number3}{step6 && number1 < 10 && <button className="carry Green"  style={{fontSize:'30px'}} onClick={() => {setStep6(false);setStep7(true);setAnswer2(answer2*10+number3);setMinus(false);setDone(true)}}>{number3}</button>}
