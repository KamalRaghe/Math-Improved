    ...
    return(
        <div className="beige container column">
           ...
           <div className="inTest">
            ...
            { correct && <div className="double Green">𝑥<span style={{fontSize:'15px',position:'relative',padding:"2px", top:"-13px"}}>2</span> 
                    {sign1[num]} {(num === 2 || num === 1) ? num1-num2:num1+num2}𝑥 {sign2[num]} {num1*num2}</div>} 
                    { wrong && <div className="double Red">𝑥<span style={{fontSize:'15px',position:'relative',padding:"2px", top:"-13px"}}>2</span> 
                    {sign1[num]} {(num === 2 || num === 1) ? num1-num2:num1+num2}𝑥 {sign2[num]} {num1*num2}</div>} 
            </div>
