...
import IntegralHelp from "@/components/intergal";
...
export default function IntegralDiffExp() {
  ...
  return (
    <div className="beige container column">
      ...
      <div className="box">
        <button style={{ marginBottom: "16px"}} className="help" onClick={()=>{setHelp(true)}}>help</button>
      </div>
      {help && <IntegralHelp terms = {terms} close={close} />}
      {correct && <Correct />}
      {wrong && <Wrong />}
