           ...
           <div className="inTest">
            ...
            <div className="box">
                ...
                {loaded && <div className=" double center">
                    ...
                    {num1}</div></div>}
                    <div className="double " style={{padding:'10px'}} >=</div>
                    {loaded && num4+num2 >= num1 && correct && <div className="double Green" style={{padding:'10px'}} >1</div>}
                    {loaded && num4+num2 >= num1 && wrong && <div className="double Red" style={{padding:'10px'}} >1</div>}
                    {loaded && correct && num1 !== num4+num2 && <div className=" Green column center" >
                        <div className=" double center" style={{borderBottom:'2px solid green', width:'45px'}} >
                            {num4+num2 < num1 ? (num4+num2)/num : (num2-num1+num4)/num}</div>
                    <div className="double" >{num1/num}</div></div>}
                    {loaded && wrong && num1 !== num4+num2 && <div className=" double Red column center" >
