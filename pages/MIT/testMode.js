...
export default function DoubleAdd(){
    ...
    const [num9, setNum9] = useState([num1,num2,num3,num4,num5])
    ...
    function mix(){
        ...
        setNum9([num1,num2,num3,num4,num5])
    ...
    return(
        <div className="beige container column">
           ...
           <div className="inTest">
            ...
            <div className="box">
                {correct && <div className="Green double" >{num1}</div>}{wrong && <div className="double Red">{num1}</div>}
            </div>
