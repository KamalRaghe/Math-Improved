    ...
    return(
        <div className="beige container column">
           ...
           <div className="inTest">
            ...
            <div style={{width:"100%"}}>
                <div className="double center"><span className="hide">0</span>{loaded && num1}<span style={{fontSize:'20px',position:'relative', top:"-13px"}}>2</span></div>
            </div>
            <div className="box">
                {correct && <div className="Green double" >{num1*num1}</div>}{wrong && <div className="double center Red">{num1*num1}</div>}
            </div>
