...
export default function Math(){
    ...
    const [array, setArray] = useState([{type: 'hello', number:"0"},{type: 'bye', number:"1"}])
    ...
    return (
        <div className="beige" style={{padding:"20px",paddingBottom:"50px"}}>
            ...
            <div style={{display:flex,justifyContent:"space-between",width:"100vw",height:"180px"}}>
                <div>
                    <div style={{position:"relative",right:"30px"}} >Sign up for cheat detection</div> 
            ...
            <div className="column" style={{display:none,paddingBottom:"20px"}} onClick={close} >
                {loaded && <button onClick={() => {setCount(1)}} className="topic">Addition</button >}
                    { count === 1 && <div style={{margin:"0",padding:"0",display:"flex",alignItems:"center"}} >
                ...
                {  count === 4 &&<Link href= {`/MIT/shortDiv`}><button className="sub-topic zoom">Short Division</button></Link>}
                ...
                { count === 'loge' &&<Link href= {`/MIT/limits`}><button className="sub-topic zoom">Intro to limits</button></Link>}
                { count === 'loge' &&<Link href= {`/MIT/derivatives`}><button className="sub-topic zoom">Intro to derivatives</button></Link>}
                { count === 'loge' &&<Link href= {`/MIT/intergal`}><button className="sub-topic zoom">Intro to Integral</button></Link>}
            </div>
        </div>     
    )
 } 