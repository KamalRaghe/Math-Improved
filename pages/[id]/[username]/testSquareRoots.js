    ...
    return(
        <div className="beige container column">
           ...
           <div className="inTest">
            ...
            <div className="box">
                <div className="double center root-top"><span className="root-tip" style={{left:'-16px'}}></span><span className="root-right" style={{left:'-7px'}} ></span><span className="root-left" style={{left:'-14px'}}></span>{loaded && num1*num1}</div>
            </div>
            <div className="box">
