           ...
           <div className="inTest">
            ...
            <div className="box">
                ...
                {loaded && <div className=" double center"><span style={{padding:'3px'}} >{num6}</span>
                    ...
                    {loaded && correct && (((num4+(num6*num5))*num1) % ((num2+(num8*num1))*num5)) > 0 && <div className=" Green double center">
                    <div className="column center" >
                        <div className="center" style={{borderBottom:'2px solid green', width:'45px'}} >
                            {(num1*(num4+(num6*num5)))%(num5*(num2+(num8*num1)))/num}</div>
                    {((num2+(num8*num1))*num5)/num}</div></div>}
                    {loaded && wrong && (((num4+(num6*num5))*num1) % ((num2+(num8*num1))*num5)) > 0 && <div className="Red double center">
                    <div className="column center" >
