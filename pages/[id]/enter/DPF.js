...
export default function DoubleAdd({Count}){
    ...
    const [count, setCount] =useState(0)
     ...
     useEffect(() =>{
         Add()
         setLoaded(true)
         const count = parseInt(window.localStorage.getItem(`${id} DPF`))
     ...
     useEffect(() =>{
         if(count > 0){
         window.localStorage.setItem(`${id} DPF`, count)
     }},[count])
    ...
    return(
        <div className="beige container column">
            <div className="Test sb"><div className="double" >
                ...
                <div className="font" >Division Proper Fraction: {loaded && count} </div>
            </div><Link href={`/${id}/${username}/DPFTest`}><button className="green test-btn">Test</button></Link></div>
            <div className="box">
            ...
            {help && <DPF num1={num4} num2={num5} close={close} num4={num2} num5={num1} />}
