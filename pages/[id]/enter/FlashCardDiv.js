    ...
    return(
        <div className="beige container column">
            <div className="Test sb"><div className="double" >
                ...
                <div className="font" >Single digit Multiplication: {score && count} </div>
            </div>
            <Link href={`/${id}/enter/shortDivTest`}>
                <button className="green test-btn">Test</button>
            </Link></div>
          <div className="center column" >
                <div className="box center" style={{width:"200px"}}>
                      {loaded && <div className="double">{loaded && num1*num2} ÷  {loaded && num2} =</div>}
                </div>
                <div className="box" style={{height:"30px",width:"200px",paddingBottom:"20px"}}>
                 {flash && <div className=" center column relative">
                    <div className="double">{(num1-1)*num2} ÷  {num2} = {num1-1}</div>
                    <div className="double">{num1*num2} ÷  {num2} = {num1}</div>
                    <div className="double">{(num1+1)*num2} ÷  {num2} = {num1+1}</div>
                    <br></br>
