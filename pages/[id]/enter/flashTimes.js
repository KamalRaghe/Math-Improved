        ...
        <div className="beige container column">
          ...
          <div className="center column" >
                <div className="box center">
                      {loaded && <div className="double">{loaded && num1} x {loaded && num2} =</div>}
                </div>
                <div className="box" style={{height:"30px",width:"200px",paddingBottom:"20px"}}>
                 {flash && <div className=" center column relative">
                    <div className="double">{num1} x {num2-1} = {num1*(num2-1)}</div>
                    <div className="double">{num1} x {num2} = {num1*num2}</div>
                    <div className="double">{num1} x {num2+1} = {num1*(num2+1)}</div>
                    <br></br>
