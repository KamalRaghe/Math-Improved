    ...
    return (
        <div style={{width:"96%"}} onClick={close} >
            ...
            <div style={{display:"flex",justifyContent:'space-between'}} >
                <h1 style={{marginLeft:'15px',paddingLeft:'15px',paddingTop:'15px', borderBottom: '2px solid black',width: '105px',height:"37px",position:"relative",bottom:"-10px"}} >Match</h1>
                <div>
                    <button className="sub-topic " onClick={()=>{setCheck(true)}} style={{marginRight:"5px"}} >Feedback</button>
                    <button className="sub-topic" onClick={()=>{setCheck(true)}} style={{marginRight:"5px",position:"relative",left:"6px"}} >Session</button>
                </div>
            </div>
            ...
            { count === 1 && <div style={{margin:"0",padding:"0",display:"flex"}} >
                <Link href= {`/${id}/enter/singleAdd`}><button className="sub-topic zoom" style={{margin:"0 20px 0 40px"}}>Single digit Addition</button></Link>
                <Link href= {`/${id}/enter/MAdd`}><button className="sub-topic zoom green"  style={{margin:"0"}} >Memersois</button></Link>
            </div>}
