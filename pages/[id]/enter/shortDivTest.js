    ...
    return(
        <div className="beige container column">
           ...
           <div className="inTest">
            ...
            <div style={{width:"100%"}}>
                <div className="double center">{loaded && num1*num2}  ÷  {loaded && num2} ={correct && <span className="Green" style={{paddingLeft:"10px"}}>{num1}</span> }{wrong && <span className="Red" style={{paddingLeft:"10px"}}>{num1}</span> }</div>
            </div>
            <div className="box">
            </div>
