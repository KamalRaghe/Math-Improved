...
import TestStepTimes from "@/components/testStepTimes";
...
export default function testDoubleAdd(){
        ...
        <div className="beige container column">
           ...
           <div className="inTest">
            ...
            <div className="box column">
                ...
                {correct && <div className="Green double lower-number">{loaded && num2*num1}</div>}{wrong && <div className="Red double lower-number``">{loaded && num2*num1}</div>}
            </div>
            <div className="box">
