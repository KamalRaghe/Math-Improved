           ...
           <div className="inTest">
            ...
            <div className="box">
                ...
                {loaded && <div className=" double center">
                    ...
                    {loaded && correct && (num2*(num7/num1))+(num4*(num7/num5)) >= num7 && <span className="double" style={{padding:'3px',color:'green'}} >{1}</span>}
                    {loaded && wrong && (num2*(num7/num1))+(num4*(num7/num5)) >= num7 && <span className="double" style={{padding:'3px',color:"red"}} >{1}</span>}
