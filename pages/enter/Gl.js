...
import Gl from "@/components/HelpGl";
...
export default function DoubleAdd(){
    ...
    useEffect(() =>{
     ...
     const [count, setCount] =useState(0)
      ...
      useEffect(() =>{
          setLoaded(true)
          const count = parseInt(window.localStorage.getItem(`${id+username} Gl`))
          setCount(count ? count : 0)
          const score = parseInt(window.localStorage.getItem(`${id+username} score`))
     ...
     return(
         <div className="beige container column">
             ...
             </div><Link href={`/enter/GlTest`}><button className="green test-btn">Test</button></Link></div>
            ...
            {help && <Gl num1 ={num1} num2={num2} close={close}/>}
