...
export default function DoubleAdd(){
    ...
    useEffect(()=>{
        ...
        for(let i= (num1*num5)  ; i > 0 ;i--){
            if ( (num5*num1) % i === 0 && (num2*num4) % i === 0){
                setNum(i)
                break
            }
        }
           ...
           <div className="inTest">
            ...
            <div className="box">
                ...
                {loaded && <div className=" double center">
                    ...
                    {correct && num4*num2 > num5*num1 && <div className="Green" >{num7}</div>}
                    {wrong && num4*num2 > num5*num1 && <div className="Red" >{num7}</div>}
                    {loaded && correct && <div className=" Green double center">
                    <div className="column center" >
                        <div className="center" style={{borderBottom:'2px solid green', width:'45px'}} >
                            {(num2*num4)/num}</div>
                    {(num1*num5)/num}</div></div>}
                    {loaded && wrong && <div className="Red double center">
                    <div className="column center" >
