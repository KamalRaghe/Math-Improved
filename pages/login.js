...
import { 
  ...
  doc, getDoc, setDoc, onSnapshot, increment 
...
export default function Home() {
  ...
  if (snapshot.empty) {
    ...
    if (!userSnap.data()?.hasSubscribed) {
      ...
      if(code){
          const statsRef = doc(db, "111NewSub", code);
  ...
  return (
    <div className="center beige column">
      ...
      <div className="box column" >   
        ...
        <br></br>
        <br></br>
       {close && <Class payed={payed} close={()=>{setClose()}} ></Class>}
     ...
     <div className="center" style={{position:"relative"}}>
         {/* <button className="sub-topic" 
          style={{margin:"0px",marginTop:"0px",backgroundColor:"yellow",color:"black"}} 
