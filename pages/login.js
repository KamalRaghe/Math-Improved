  ...
  return (
    <div className="center beige column">
      ...
      <div className="box column" >   
        ...
        {<button className="topic" style={{backgroundColor:"yellow",color:"black",fontWeight:"bolder",borderRadius:"20px",width:'250px', height:"50px"}} onClick={()=>{Free(id)}} >Start Free Trial</button>}
